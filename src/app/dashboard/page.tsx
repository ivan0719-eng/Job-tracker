...
export default function DashBoard(){
    ...
    {
        return [
            { name: 'Applied', value: stats.applied, fill: '#3B82F6' },    // Blue
            { name: 'Interview', value: stats.interview, fill: '#F59E0B' }, // Orange
            { name: 'Offer', value: stats.offer, fill: '#10B981' },        // Green
        ...
        <main className="min-h-screen p-8 bg-gray-50">
            <div className="max-w-6xl mx-auto">
                ...
                {isLoading ? (
                    ...
                    <div>
                        <p >
                            Loaded {applications?.length} applications!
                        </p>
                            ...
                            <>
                                ...
                                <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-8'>
                                    ...
                                    <div className='bg-white p-6 rounded-lg shadow'>
                                        <div className='text-gray-500 text-sm font-mdeium'>Total Application</div>
                                        <div className=' text-3xl font-bold text-blue-600 mt-2'>{stats.total}</div>
                                    </div>

                                    {/* Response Rates */}
                                    <div className='bg-white p-6 rounded-lg shadow'>
                                        <div className='text-gray-500 text-sm font-mdeium'>Response Rates</div>
                                        <div className=' text-3xl font-bold text-blue-600 mt-2'>{stats.responseRate}</div>
                                    </div>

                                    {/* Success Rate */}
                                    <div className='bg-white p-6 rounded-lg shadow'>
                                        <div className='text-gray-500 text-sm font-mdeium'>Success Rate</div>
                                        <div className=' text-3xl font-bold text-blue-600 mt-2'>{stats.successRate}</div>
                                    </div>

                                    {/*Interviews */}
                                    <div className='bg-white p-6 rounded-lg shadow'>
                                        <div className='text-gray-500 text-sm font-mdeium'>Interviews</div>
                                        <div className=' text-3xl font-bold text-blue-600 mt-2'>{stats.interview}</div>
                                    </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow mb-8 ">
                    <p className="text-gray-600">
                        ...
                        Charts and statistics will go here.
                    </p>
                </div>

                {/*Status breakdown */}
                <div className='bg-white p-6 rounded-lg shadow mb-8'>
                    <h2 className='className=text-xl font-bold mb-4 text-gray-500'>Status Breakdown</h2>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 '>
                    ...
                    <div className='bg-white p-6 rounded-lg shadow margin-top:30px '>
                        <h2 className="text-xl font-bold mb-4">Application By Status</h2>
